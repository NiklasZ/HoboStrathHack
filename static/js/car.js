...
function addCar()
{
    carBody = game.add.sprite(100, 400,'moto');; //CARBODY
    wheel_front = game.add.sprite(140, 430,'wheel'); //FRONT WHEEL
    wheel_back = game.add.sprite(60, 430,'wheel');; //BACK WHEEL 
...
function addJump()
{
    var groundSegment = [[600,h],[700,h],[700,h-50],[600,h-40]];    
